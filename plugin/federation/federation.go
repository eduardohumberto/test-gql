...
import (
	...
	"github.com/eduardohumberto/test-gql/codegen"
	"github.com/eduardohumberto/test-gql/codegen/config"
	"github.com/eduardohumberto/test-gql/codegen/templates"
	"github.com/eduardohumberto/test-gql/plugin"
)
	...
	builtins := config.TypeMap{
		"_Service": {
			Model: config.StringList{
				"github.com/eduardohumberto/test-gql/plugin/federation/fedruntime.Service",
			},
		},
		"_Entity": {
			Model: config.StringList{
				"github.com/eduardohumberto/test-gql/plugin/federation/fedruntime.Entity",
			},
		},
		"Entity": {
			Model: config.StringList{
		...
		"_Any": {
			Model: config.StringList{"github.com/eduardohumberto/test-gql/graphql.Map"},
		},
	}
