...
server in gqlgen. You can find the finished result in the [examples directory](https://github.com/eduardohumberto/test-gql/tree/master/example/federation).
...
```bash
go run github.com/eduardohumberto/test-gql
```
