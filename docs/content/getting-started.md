...
$ go get github.com/eduardohumberto/test-gql
```
...
```bash
$ go run github.com/eduardohumberto/test-gql init
```
...
And run `go run github.com/eduardohumberto/test-gql generate`.
...
```go
//go:generate go run github.com/eduardohumberto/test-gql
```
